...
@REM set TOMCAT_LIB=D:\logiciel\apache-tomcat-10.1.28\apache-tomcat-10.1.28\lib
set TOMCAT_LIB=D:\logiciels\apache-tomcat-10.1.31\lib
set FRAMEWORK_JAR=..\Framework\framework.jar
set WAR_NAME=%APP_NAME%.war
@REM set TOMCAT_PATH=D:\logiciel\apache-tomcat-10.1.28\apache-tomcat-10.1.28
